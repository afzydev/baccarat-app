...
import PriceDragDrop from './Components/PriceDragDrop/PriceDragDrop';
...
class App extends Component {
    ...
    selectWager(wagerType) {
        ...
        if(wagerType === "tie-coordinates") {
            cln.className = this.state.coinType+'-chip tiecurrency';
        } else {
            cln.className = this.state.coinType+'-chip currency';
        }
    ...
    openOneByOne(n, obj) {
      setTimeout(function() {
        ...
        cardImage.setAttribute('src', 'images/'+cardObj.f+'.png');
        ...
        hiddenImage.setAttribute('src', 'images/hidden.png');
        hiddenImage.setAttribute('id', 'hidden-card-'+n);
        hiddenImage.setAttribute('height', '100px');
        hiddenImage.setAttribute('width', '70px');
    ...
    render() {
      ...
      return (<div>
                ...
                <Header totalbet={this.state.betamount} playerOverAllbalance={this.state.playerOverAllbalance} />
                <div id="chip-container"></div>
                <div id="coins-container"></div>
                <div id="Content" className="container">
                    <ScoreCards playerFinalScore={this.state.playerFinalScore} bankerFinalScore={this.state.bankerFinalScore}  />
                    <Cards />
                    <PriceDragDrop 
                        ...
                        selectOne={this.SelectAmount.bind(this, 'one')}
                        selectTen={this.SelectAmount.bind(this, 'ten')}
                        selectFifty={this.SelectAmount.bind(this, 'fifty')}
